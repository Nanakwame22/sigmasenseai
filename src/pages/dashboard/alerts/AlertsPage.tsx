                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap mb-0.5">
                          ...
                          <span className={`text-[10px] font-bold uppercase tracking-wide px-2 py-0.5 rounded-md ${sev.bg} ${sev.text} border ${sev.border} flex-shrink-0`}>
                            {sev.label}
                          </span>
                          <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-md ${statusCfg.bg} ${statusCfg.text} flex-shrink-0`}>
                            {statusCfg.label}
                          </span>
                          {isAutoGenerated && (
                            <span className="text-[10px] font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-2 py-0.5 rounded-md flex-shrink-0 flex items-center gap-1">
                              <i className="ri-radar-line text-xs"></i>
                              Auto-detected
                            </span>
                          )}
                          {alert.category && (
                            <span className="text-[10px] text-gray-500 bg-gray-100 px-2 py-0.5 rounded-md flex-shrink-0">
                              {alert.category}
                            </span>
                          )}
                        </div>
